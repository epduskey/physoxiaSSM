...
params_test = params_tune
species_params(params_test)$R_max = c(7.0e+07,3.6e+08,6.1e+11,2.4e+10)
sim_test = project(params_test, t_max = t_tune, effort = effort_hypoxia)
plotBiomassObservedVsModel(sim_test)
plotBiomass(sim_test)

# Fit biomass and growth
par_bg = c(log10(c(7.0e+07,3.6e+08,6.1e+11,2.4e+10)), log10(species_params(params_tune)$gamma))
...
save(object = o_fit, file = "Calibration/o_fit.rda")

# Save the final objects
save(object = params_tune, file = "Calibration/params_tune_o.rda")
save(object = params_time, file = "Calibration/params_time_o.rda")


########## X. Analysis ##########

# Load the final objects
load("Calibration/params_tune_o.rda")
load("Calibration/params_time_o.rda")
...
save(object = params_full, file = "Calibration/params_full_o.rda")