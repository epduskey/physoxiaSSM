...
save(object = none_fit, file = "Calibration/none_fit.rda")

# Save the final objects
save(object = params_tune, file = "Calibration/params_tune_none.rda")
save(object = params_time, file = "Calibration/params_time_none.rda")


########## X. Analysis ##########

# Load the final objects
load("Calibration/params_tune_none.rda")
load("Calibration/params_time_none.rda")
...
save(object = params_full, file = "Calibration/params_full_none.rda")