...
# Fit yield
par_yield = c(0.00, 0.21, 0.32, 0.28)
...
save(object = m_fit, file = "Calibration/m_fit.rda")

# Save the final objects
save(object = params_tune, file = "Calibration/params_tune_m.rda")
save(object = params_time, file = "Calibration/params_time_m.rda")


########## X. Analysis ##########

# Load the final objects
load("Calibration/params_tune_m.rda")
load("Calibration/params_time_m.rda")
...
save(object = params_full, file = "Calibration/params_full_m.rda")