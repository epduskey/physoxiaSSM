...
# Last modified: February 2, 2023 by EPD
...
species_mat = sp_mat(rmax = c(2.0e+08,8.0e+08,2.1e+11,2.0e+10))
...
species_params(params_test)$gamma = c(5.1e-11, 3.5e-11, 2.4e-11, 3.0e-11)
...
# Fit occupancy
species_params(params_tune)$z0 = c(0.00, 0.23, 0.32, 0.27)
species_params(params_tune)$gamma = c(5.1e-11, 3.5e-11, 2.4e-11, 3.0e-11)
par_occ = c(0.8, 0.1)
...
params_test = params_tune
species_params(params_test)$R_max = c(7.1e+07,4.1e+08,5.9e+11,2.5e+10)
sim_test = project(params_test, t_max = t_tune, effort = effort_hypoxia)
plotBiomassObservedVsModel(sim_test)
plotBiomass(sim_test)

# Fit biomass and growth
par_bg = c(log10(c(7.1e+07,4.1e+08,5.9e+11,2.5e+10)), log10(species_params(params_tune)$gamma))
...
save(object = bo_fit, file = "Calibration/bo_fit.rda")

# Save the final objects
save(object = params_tune, file = "Calibration/params_tune_bo.rda")
save(object = params_time, file = "Calibration/params_time_bo.rda")


########## X. Analysis ##########

# Load the final objects
load("Calibration/params_tune_bo.rda")
load("Calibration/params_time_bo.rda")
...
save(object = params_full, file = "Calibration/params_full_bo.rda")