...
species_mat = sp_mat(rmax = c(2.0e+08,8.0e+08,2.1e+11,1.9e+10))
...
params_test = params_tune
species_params(params_test)$R_max = c(7.7e+07,4.2e+08,6.3e+11,2.5e+10)
sim_test = project(params_test, t_max = t_tune, effort = effort_hypoxia)
plotBiomassObservedVsModel(sim_test)
plotBiomass(sim_test)

# Fit biomass and growth
par_bg = c(log10(c(7.7e+07,4.2e+08,6.3e+11,2.5e+10)), log10(species_params(params_tune)$gamma))
...
save(object = b_fit, file = "Calibration/b_fit.rda")

# Save the final objects
save(object = params_tune, file = "Calibration/params_tune_b.rda")
save(object = params_time, file = "Calibration/params_time_b.rda")


########## X. Analysis ##########

# Load the final objects
load("Calibration/params_tune_b.rda")
load("Calibration/params_time_b.rda")
...
save(object = params_full, file = "Calibration/params_full_b.rda")