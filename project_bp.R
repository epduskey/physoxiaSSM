...
species_mat = sp_mat(rmax = c(4.2e+08,9.6e+08,2.0e+11,1.9e+10))
...
species_params(params_test)$z0 = c(0.06, 0.22, 0.30, 0.25)
...
# Fit yield
par_yield = c(0.06, 0.22, 0.30, 0.25)
...
params_test = params_tune
species_params(params_test)$R_max = c(1.1e+08,4.2e+08,4.9e+11,2.3e+10)
sim_test = project(params_test, t_max = t_tune, effort = effort_hypoxia)
plotBiomassObservedVsModel(sim_test)
plotBiomass(sim_test)

# Fit biomass and growth
par_bg = c(log10(c(1.1e+08,4.2e+08,4.9e+11,2.3e+10)), log10(species_params(params_tune)$gamma))
...
save(object = bp_fit, file = "Calibration/bp_fit.rda")

# Save the final objects
save(object = params_tune, file = "Calibration/params_tune_bp.rda")
save(object = params_time, file = "Calibration/params_time_bp.rda")


########## X. Analysis ##########

# Load the final objects
load("Calibration/params_tune_bp.rda")
load("Calibration/params_time_bp.rda")
...
save(object = params_full, file = "Calibration/params_full_bp.rda")