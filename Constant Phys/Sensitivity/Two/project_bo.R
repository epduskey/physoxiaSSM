...
species_mat = sp_mat(rmax = c(1.8e+08,7.2e+08,2.1e+11,2.0e+10))
...
species_params(params_test)$z0 = c(0.00, 0.23, 0.32, 0.26)
species_params(params_test)$gamma = c(5.0e-11, 3.4e-11, 2.4e-11, 3.0e-11)
...
# Fit occupancy
species_params(params_tune)$z0 = c(0.00, 0.23, 0.32, 0.26)
species_params(params_tune)$gamma = c(5.0e-11, 3.4e-11, 2.4e-11, 3.0e-11)
...
occ.optim = optimParallel(par = par_occ, fn = bocc_optim, params = params_tune, dat = cod_benthic, yr = yr_occ, t = t_occ, effort = effort_hypoxia, lower = c(0,0), method = "L-BFGS-B", control = list(factr=1e8), parallel=list(cl=cl,loginfo=T))
stopCluster(cl)
...
params_test = params_tune
species_params(params_test)$R_max = c(6.8e+07,3.8e+08,5.8e+11,2.5e+10)
sim_test = project(params_test, t_max = t_tune, effort = effort_hypoxia)
plotBiomassObservedVsModel(sim_test)
plotBiomass(sim_test)

# Fit biomass and growth
par_bg = c(log10(c(6.8e+07,3.8e+08,5.8e+11,2.5e+10)), log10(species_params(params_tune)$gamma))
...
save(object = bo_fit, file = "Sensitivity/Two/Calibration/bo_fit.rda")

# Save the final objects
save(object = params_tune, file = "Sensitivity/Two/Calibration/params_tune_bo.rda")
save(object = params_time, file = "Sensitivity/Two/Calibration/params_time_bo.rda")


########## X. Analysis ##########

# Load the final objects
load("Sensitivity/Two/Calibration/params_tune_bo.rda")
load("Sensitivity/Two/Calibration/params_time_bo.rda")
...
save(object = params_full, file = "Sensitivity/Two/Calibration/params_full_bo.rda")