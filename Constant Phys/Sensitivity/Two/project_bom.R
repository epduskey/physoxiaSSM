...
species_mat = sp_mat(rmax = c(1.9e+08,7.3e+08,2.1e+11,1.9e+10))
...
species_params(params_test)$z0 = c(0.00, 0.22, 0.31, 0.25)
...
# Fit occupancy
species_params(params_tune)$z0 = c(0.00, 0.22, 0.31, 0.25)
...
params_test = params_tune
species_params(params_test)$R_max = c(7.5e+07,3.9e+08,5.8e+11,2.4e+10)
sim_test = project(params_test, t_max = t_tune, effort = effort_hypoxia)
plotBiomassObservedVsModel(sim_test)
plotBiomass(sim_test)

# Fit biomass and growth
par_bg = c(log10(c(7.5e+07,3.9e+08,5.8e+11,2.4e+10)), log10(species_params(params_tune)$gamma))
...
save(object = bom_fit, file = "Sensitivity/Two/Calibration/bom_fit.rda")

# Save the final objects
save(object = params_tune, file = "Sensitivity/Two/Calibration/params_tune_bom.rda")
save(object = params_time, file = "Sensitivity/Two/Calibration/params_time_bom.rda")


########## X. Analysis ##########

# Load the final objects
load("Sensitivity/Two/Calibration/params_tune_bom.rda")
load("Sensitivity/Two/Calibration/params_time_bom.rda")
...
save(object = params_full, file = "Sensitivity/Two/Calibration/params_full_bom.rda")