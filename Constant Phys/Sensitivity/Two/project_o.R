...
species_mat = sp_mat(rmax = c(1.7e+08,6.7e+08,2.1e+11,2.0e+10))
...
species_params(params_test)$z0 = c(0.00, 0.22, 0.31, 0.27)
...
# Fit occupancy
species_params(params_tune)$z0 = c(0.00, 0.22, 0.31, 0.27)
...
params_test = params_tune
species_params(params_test)$R_max = c(6.7e+07,3.6e+08,5.8e+11,2.5e+10)
sim_test = project(params_test, t_max = t_tune, effort = effort_hypoxia)
plotBiomassObservedVsModel(sim_test)
plotBiomass(sim_test)

# Fit biomass and growth
par_bg = c(log10(c(6.7e+07,3.6e+08,5.8e+11,2.5e+10)), log10(species_params(params_tune)$gamma))
...
save(object = o_fit, file = "Sensitivity/Two/Calibration/o_fit.rda")

# Save the final objects
save(object = params_tune, file = "Sensitivity/Two/Calibration/params_tune_o.rda")
save(object = params_time, file = "Sensitivity/Two/Calibration/params_time_o.rda")


########## X. Analysis ##########

# Load the final objects
load("Sensitivity/Two/Calibration/params_tune_o.rda")
load("Sensitivity/Two/Calibration/params_time_o.rda")
...
save(object = params_full, file = "Sensitivity/Two/Calibration/params_full_o.rda")