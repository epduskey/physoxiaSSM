...
species_mat = sp_mat(rmax = c(2.8e+08,8.6e+08,2.1e+11,2.0e+10))
...
species_params(params_test)$z0 = c(0.05, 0.23, 0.31, 0.26)
...
# Fit occupancy
species_params(params_tune)$z0 = c(0.05, 0.23, 0.31, 0.26)
...
params_test = params_tune
species_params(params_test)$R_max = c(9.0e+07,4.2e+08,5.2e+11,2.4e+10)
sim_test = project(params_test, t_max = t_tune, effort = effort_hypoxia)
plotBiomassObservedVsModel(sim_test)
plotBiomass(sim_test)

# Fit biomass and growth
par_bg = c(log10(c(9.0e+07,4.2e+08,5.2e+11,2.4e+10)), log10(species_params(params_tune)$gamma))
