...
species_mat = sp_mat(rmax = c(3.5e+08,8.8e+08,2.0e+11,1.9e+10))
...
species_params(params_test)$z0 = c(0.06, 0.22, 0.33, 0.26)
species_params(params_test)$gamma = c(9.0e-11, 4.0e-11, 2.5e-11, 3.0e-11)
...
# Fit yield
par_yield = c(0.06, 0.22, 0.33, 0.26)
species_params(params_tune)$gamma = c(9.0e-11, 4.0e-11, 2.5e-11, 3.0e-11)
...
params_test = params_tune
species_params(params_test)$R_max = c(9.8e+07,4.0e+08,5.4e+11,2.4e+10)
sim_test = project(params_test, t_max = t_tune, effort = effort_hypoxia)
plotBiomassObservedVsModel(sim_test)
plotBiomass(sim_test)

# Fit biomass and growth
par_bg = c(log10(c(9.8e+07,4.0e+08,5.4e+11,2.4e+10)), log10(species_params(params_tune)$gamma))
