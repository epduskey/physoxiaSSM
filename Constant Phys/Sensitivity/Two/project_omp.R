...
species_mat = sp_mat(rmax = c(2.9e+08,8.7e+08,2.1e+11,1.9e+10))
...
species_params(params_test)$z0 = c(0.05, 0.24, 0.30, 0.25)
species_params(params_test)$gamma = c(7.7e-11, 4.0e-11, 2.3e-11, 3.0e-11)
...
# Fit occupancy
species_params(params_tune)$gamma = c(7.7e-11, 4.0e-11, 2.3e-11, 3.0e-11)
species_params(params_tune)$z0 = c(0.05, 0.24, 0.30, 0.25)
