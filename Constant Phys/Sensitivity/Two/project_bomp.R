...
# Last modified: December 24, 2022 by EPD
...
species_mat = sp_mat(rmax = c(3.2e+08,9.4e+08,2.1e+11,2.0e+10))
...
species_params(params_test)$z0 = c(0.05, 0.23, 0.30, 0.25)
species_params(params_test)$gamma = c(7.9e-11, 4.1e-11, 2.3e-11, 3.0e-11)
...
# Fit occupancy
species_params(params_tune)$z0 = c(0.05, 0.23, 0.30, 0.25)
species_params(params_tune)$gamma = c(7.9e-11, 4.1e-11, 2.3e-11, 3.0e-11)
...
params_test = params_tune
species_params(params_test)$R_max = c(9.8e+07,4.3e+08,4.9e+11,2.4e+10)
sim_test = project(params_test, t_max = t_tune, effort = effort_hypoxia)
plotBiomassObservedVsModel(sim_test)
plotBiomass(sim_test)

# Fit biomass and growth
par_bg = c(log10(c(9.8e+07,4.3e+08,4.9e+11,2.4e+10)), log10(species_params(params_tune)$gamma))
