# Run hypoxia model sensitivity analysis for B
...
species_params(params_test)$z0 = c(0.00, 0.23, 0.32, 0.27)
species_params(params_test)$gamma = c(5.1e-11, 3.4e-11, 2.3e-11, 3.0e-11)
...
# Fit yield
par_yield = c(0.00, 0.23, 0.32, 0.27)
species_params(params_tune)$gamma = c(5.1e-11, 3.4e-11, 2.3e-11, 3.0e-11)
...
params_test = params_tune
species_params(params_test)$R_max = c(7.4e+07,3.9e+08,6.0e+11,2.5e+10)
sim_test = project(params_test, t_max = t_tune, effort = effort_hypoxia)
plotBiomassObservedVsModel(sim_test)
plotBiomass(sim_test)

# Fit biomass and growth
par_bg = c(log10(c(7.4e+07,3.9e+08,6.0e+11,2.5e+10)), log10(species_params(params_tune)$gamma))
...
save(object = b_fit, file = "Sensitivity/Two/Calibration/b_fit.rda")

# Save the final objects
save(object = params_tune, file = "Sensitivity/Two/Calibration/params_tune_b.rda")
save(object = params_time, file = "Sensitivity/Two/Calibration/params_time_b.rda")


########## X. Analysis ##########

# Load the final objects
load("Sensitivity/Two/Calibration/params_tune_b.rda")
load("Sensitivity/Two/Calibration/params_time_b.rda")
...
save(object = params_full, file = "Sensitivity/Two/Calibration/params_full_b.rda")