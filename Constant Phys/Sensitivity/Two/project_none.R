...
save(object = none_fit, file = "Sensitivity/Two/Calibration/none_fit.rda")

# Save the final objects
save(object = params_tune, file = "Sensitivity/Two/Calibration/params_tune_none.rda")
save(object = params_time, file = "Sensitivity/Two/Calibration/params_time_none.rda")


########## X. Analysis ##########

# Load the final objects
load("Sensitivity/Two/Calibration/params_tune_none.rda")
load("Sensitivity/Two/Calibration/params_time_none.rda")
...
save(object = params_full, file = "Sensitivity/Two/Calibration/params_full_none.rda")