...
species_mat = sp_mat(rmax = c(2.1e+08,7.6e+08,2.0e+11,1.9e+10))
...
species_params(params_test)$gamma = c(5.1e-11, 3.4e-11, 2.5e-11, 3.1e-11)
...
species_params(params_tune)$gamma = c(5.1e-11, 3.4e-11, 2.5e-11, 3.1e-11)
...
params_test = params_tune
species_params(params_test)$R_max = c(7.8e+07,4.0e+08,6.0e+11,2.5e+10)
sim_test = project(params_test, t_max = t_tune, effort = effort_hypoxia)
plotBiomassObservedVsModel(sim_test)
plotBiomass(sim_test)

# Fit biomass and growth
par_bg = c(log10(c(7.8e+07,4.0e+08,6.0e+11,2.5e+10)), log10(species_params(params_tune)$gamma))
...
save(object = bm_fit, file = "Sensitivity/Two/Calibration/bm_fit.rda")

# Save the final objects
save(object = params_tune, file = "Sensitivity/Two/Calibration/params_tune_bm.rda")
save(object = params_time, file = "Sensitivity/Two/Calibration/params_time_bm.rda")


########## X. Analysis ##########

# Load the final objects
load("Sensitivity/Two/Calibration/params_tune_bm.rda")
load("Sensitivity/Two/Calibration/params_time_bm.rda")
...
save(object = params_full, file = "Sensitivity/Two/Calibration/params_full_bm.rda")