...
# Fit yield
par_yield = c(0.00, 0.22, 0.33, 0.27)
...
params_test = params_tune
species_params(params_test)$R_max = c(7.2e+07,3.7e+08,5.9e+11,2.5e+10)
sim_test = project(params_test, t_max = t_tune, effort = effort_hypoxia)
plotBiomassObservedVsModel(sim_test)
plotBiomass(sim_test)

# Fit biomass and growth
par_bg = c(log10(c(7.2e+07,3.7e+08,5.9e+11,2.5e+10)), log10(species_params(params_tune)$gamma))
...
save(object = none_fit, file = "Sensitivity/Three/Calibration/none_fit.rda")

# Save the final objects
save(object = params_tune, file = "Sensitivity/Three/Calibration/params_tune_none.rda")
save(object = params_time, file = "Sensitivity/Three/Calibration/params_time_none.rda")


########## X. Analysis ##########

# Load the final objects
load("Sensitivity/Three/Calibration/params_tune_none.rda")
load("Sensitivity/Three/Calibration/params_time_none.rda")
...
save(object = params_full, file = "Sensitivity/Three/Calibration/params_full_none.rda")