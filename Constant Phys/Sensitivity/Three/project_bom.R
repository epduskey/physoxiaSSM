...
species_mat = sp_mat(rmax = c(2.3e+08,7.7e+08,2.0e+11,1.9e+10))
...
species_params(params_test)$z0 = c(0.00, 0.22, 0.32, 0.26)
species_params(params_test)$gamma = c(5.2e-11, 3.4e-11, 2.3e-11, 3.0e-11)
...
# Fit occupancy
species_params(params_tune)$z0 = c(0.00, 0.22, 0.32, 0.26)
species_params(params_tune)$gamma = c(5.2e-11, 3.4e-11, 2.3e-11, 3.0e-11)
...
params_test = params_tune
species_params(params_test)$R_max = c(8.3e+07,3.9e+08,5.8e+11,2.4e+10)
sim_test = project(params_test, t_max = t_tune, effort = effort_hypoxia)
plotBiomassObservedVsModel(sim_test)
plotBiomass(sim_test)

# Fit biomass and growth
par_bg = c(log10(c(8.3e+07,3.9e+08,5.8e+11,2.4e+10)), log10(species_params(params_tune)$gamma))
...
save(object = bom_fit, file = "Sensitivity/Three/Calibration/bom_fit.rda")

# Save the final objects
save(object = params_tune, file = "Sensitivity/Three/Calibration/params_tune_bom.rda")
save(object = params_time, file = "Sensitivity/Three/Calibration/params_time_bom.rda")


########## X. Analysis ##########

# Load the final objects
load("Sensitivity/Three/Calibration/params_tune_bom.rda")
load("Sensitivity/Three/Calibration/params_time_bom.rda")
...
save(object = params_full, file = "Sensitivity/Three/Calibration/params_full_bom.rda")