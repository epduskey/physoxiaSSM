# Run hypoxia model sensitivity analysis for OP
...
species_mat = sp_mat(rmax = c(4.3e+08,8.1e+08,2.0e+11,1.9e+10))
...
species_params(params_test)$z0 = c(0.07, 0.20, 0.31, 0.26)
species_params(params_test)$gamma = c(1.1e-10, 3.8e-11, 2.4e-11, 3.1e-11)
...
# Fit occupancy
species_params(params_tune)$z0 = c(0.07, 0.20, 0.31, 0.26)
species_params(params_tune)$gamma = c(1.1e-10, 3.8e-11, 2.4e-11, 3.1e-11)
...
params_test = params_tune
species_params(params_test)$R_max = c(1.2e+08,3.7e+08,5.2e+11,2.4e+10)
sim_test = project(params_test, t_max = t_tune, effort = effort_hypoxia)
plotBiomassObservedVsModel(sim_test)
plotBiomass(sim_test)

# Fit biomass and growth
par_bg = c(log10(c(1.2e+08,3.7e+08,5.2e+11,2.4e+10)), log10(species_params(params_tune)$gamma))
