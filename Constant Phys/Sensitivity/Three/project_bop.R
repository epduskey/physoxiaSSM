# Run hypoxia model sensitivity analysis for BOP
...
species_mat = sp_mat(rmax = c(5.2e+08,9.3e+08,2.0e+11,1.9e+10))
...
species_params(params_test)$z0 = c(0.09, 0.23, 0.30, 0.25)
...
# Fit occupancy
species_params(params_tune)$z0 = c(0.09, 0.23, 0.30, 0.25)
...
params_test = params_tune
species_params(params_test)$R_max = c(1.3e+08,4.0e+08,4.8e+11,2.3e+10)
sim_test = project(params_test, t_max = t_tune, effort = effort_hypoxia)
plotBiomassObservedVsModel(sim_test)
plotBiomass(sim_test)

# Fit biomass and growth
par_bg = c(log10(c(1.3e+08,4.0e+08,4.8e+11,2.3e+10)), log10(species_params(params_tune)$gamma))
