# Run hypoxia model sensitivity analysis
...
species_mat = sp_mat(rmax = c(2.0e+08,6.9e+08,2.0e+11,1.9e+10))
...
species_params(params_test)$z0 = c(0.00, 0.21, 0.33, 0.27)
...
# Fit yield
par_yield = c(0.00, 0.21, 0.33, 0.27)
...
params_test = params_tune
species_params(params_test)$R_max = c(8.1e+07,3.7e+08,6.0e+11,2.5e+10)
sim_test = project(params_test, t_max = t_tune, effort = effort_hypoxia)
plotBiomassObservedVsModel(sim_test)
plotBiomass(sim_test)

# Fit biomass and growth
par_bg = c(log10(c(8.1e+07,3.7e+08,6.0e+11,2.5e+10)), log10(species_params(params_tune)$gamma))
...
save(object = m_fit, file = "Sensitivity/Three/Calibration/m_fit.rda")

# Save the final objects
save(object = params_tune, file = "Sensitivity/Three/Calibration/params_tune_m.rda")
save(object = params_time, file = "Sensitivity/Three/Calibration/params_time_m.rda")


########## X. Analysis ##########

# Load the final objects
load("Sensitivity/Three/Calibration/params_tune_m.rda")
load("Sensitivity/Three/Calibration/params_time_m.rda")
...
save(object = params_full, file = "Sensitivity/Three/Calibration/params_full_m.rda")