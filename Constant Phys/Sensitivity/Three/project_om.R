# Run hypoxia model sensitivity analysis for OM
...
species_mat = sp_mat(rmax = c(2.1e+08,6.9e+08,2.1e+11,1.9e+10))
...
species_params(params_test)$z0 = c(0.00, 0.21, 0.34, 0.27)
species_params(params_test)$gamma = c(4.9e-11, 3.2e-11, 2.5e-11, 3.0e-11)
...
# Fit occupancy
species_params(params_tune)$z0 = c(0.00, 0.21, 0.34, 0.27)
species_params(params_tune)$gamma = c(4.9e-11, 3.2e-11, 2.5e-11, 3.0e-11)
...
params_test = params_tune
species_params(params_test)$R_max = c(8.0e+07,3.6e+08,6.3e+11,2.5e+10)
sim_test = project(params_test, t_max = t_tune, effort = effort_hypoxia)
plotBiomassObservedVsModel(sim_test)
plotBiomass(sim_test)

# Fit biomass and growth
par_bg = c(log10(c(8.0e+07,3.6e+08,6.3e+11,2.5e+10)), log10(species_params(params_tune)$gamma))
...
save(object = om_fit, file = "Sensitivity/Three/Calibration/om_fit.rda")

# Save the final objects
save(object = params_tune, file = "Sensitivity/Three/Calibration/params_tune_om.rda")
save(object = params_time, file = "Sensitivity/Three/Calibration/params_time_om.rda")


########## X. Analysis ##########

# Load the final objects
load("Sensitivity/Three/Calibration/params_tune_om.rda")
load("Sensitivity/Three/Calibration/params_time_om.rda")
...
save(object = params_full, file = "Sensitivity/Three/Calibration/params_full_om.rda")