# Run hypoxia model sensitivity analysis for O
...
species_mat = sp_mat(rmax = c(1.8e+08,6.7e+08,2.0e+11,1.9e+10))
...
# Make sure physiological parameters are set to one
...
species_params(params_test)$gamma = c(4.8e-11, 3.2e-11, 2.3e-11, 3.1e-11)
...
species_params(params_tune)$gamma = c(4.8e-11, 3.2e-11, 2.3e-11, 3.1e-11)
...
params_test = params_tune
species_params(params_test)$R_max = c(7.1e+07,3.6e+08,6.1e+11,2.5e+10)
sim_test = project(params_test, t_max = t_tune, effort = effort_hypoxia)
plotBiomassObservedVsModel(sim_test)
plotBiomass(sim_test)

# Fit biomass and growth
par_bg = c(log10(c(7.1e+07,3.6e+08,6.1e+11,2.5e+10)), log10(species_params(params_tune)$gamma))
...
save(object = o_fit, file = "Sensitivity/Three/Calibration/o_fit.rda")

# Save the final objects
save(object = params_tune, file = "Sensitivity/Three/Calibration/params_tune_o.rda")
save(object = params_time, file = "Sensitivity/Three/Calibration/params_time_o.rda")


########## X. Analysis ##########

# Load the final objects
load("Sensitivity/Three/Calibration/params_tune_o.rda")
load("Sensitivity/Three/Calibration/params_time_o.rda")
...
save(object = params_full, file = "Sensitivity/Three/Calibration/params_full_o.rda")