...
species_mat = sp_mat(rmax = c(2.0e+08,7.6e+08,2.0e+11,1.9e+10))
...
# Fit yield
par_yield = c(0.00, 0.22, 0.32, 0.27)
...
params_test = params_tune
species_params(params_test)$R_max = c(7.6e+07,4.0e+08,6.0e+11,2.5e+10)
sim_test = project(params_test, t_max = t_tune, effort = effort_hypoxia)
plotBiomassObservedVsModel(sim_test)
plotBiomass(sim_test)

# Fit biomass and growth
par_bg = c(log10(c(7.6e+07,4.0e+08,6.0e+11,2.5e+10)), log10(species_params(params_tune)$gamma))
...
save(object = b_fit, file = "Sensitivity/Three/Calibration/b_fit.rda")

# Save the final objects
save(object = params_tune, file = "Sensitivity/Three/Calibration/params_tune_b.rda")
save(object = params_time, file = "Sensitivity/Three/Calibration/params_time_b.rda")


########## X. Analysis ##########

# Load the final objects
load("Sensitivity/Three/Calibration/params_tune_b.rda")
load("Sensitivity/Three/Calibration/params_time_b.rda")
...
save(object = params_full, file = "Sensitivity/Three/Calibration/params_full_b.rda")