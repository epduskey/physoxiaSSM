...
params_test = params_tune
species_params(params_test)$R_max = c(7.5e+07,3.9e+08,6.1e+11,2.5e+10)
sim_test = project(params_test, t_max = t_tune, effort = effort_hypoxia)
plotBiomassObservedVsModel(sim_test)
plotBiomass(sim_test)

# Fit biomass and growth
par_bg = c(log10(c(7.5e+07,3.9e+08,6.1e+11,2.5e+10)), log10(species_params(params_tune)$gamma))
...
save(object = b_fit, file = "Sensitivity/One/Calibration/b_fit.rda")

# Save the final objects
save(object = params_tune, file = "Sensitivity/One/Calibration/params_tune_b.rda")
save(object = params_time, file = "Sensitivity/One/Calibration/params_time_b.rda")


########## X. Analysis ##########

# Load the final objects
load("Sensitivity/One/Calibration/params_tune_b.rda")
load("Sensitivity/One/Calibration/params_time_b.rda")
...
save(object = params_full, file = "Sensitivity/One/Calibration/params_full_b.rda")