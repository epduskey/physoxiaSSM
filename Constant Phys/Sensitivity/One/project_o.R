...
# Last modified: November 28, 2022 by EPD
...
species_mat = sp_mat(rmax = c(1.8e+08,6.8e+08,2.0e+11,1.9e+10))
...
params_test = params_tune
species_params(params_test)$R_max = c(7.3e+07,3.7e+08,6.0e+11,2.5e+10)
sim_test = project(params_test, t_max = t_tune, effort = effort_hypoxia)
plotBiomassObservedVsModel(sim_test)
plotBiomass(sim_test)

# Fit biomass and growth
par_bg = c(log10(c(7.3e+07,3.7e+08,6.0e+11,2.5e+10)), log10(species_params(params_tune)$gamma))
...
save(object = o_fit, file = "Sensitivity/One/Calibration/o_fit.rda")

# Save the final objects
save(object = params_tune, file = "Sensitivity/One/Calibration/params_tune_o.rda")
save(object = params_time, file = "Sensitivity/One/Calibration/params_time_o.rda")


########## X. Analysis ##########

# Load the final objects
load("Sensitivity/One/Calibration/params_tune_o.rda")
load("Sensitivity/One/Calibration/params_time_o.rda")
...
save(object = params_full, file = "Sensitivity/One/Calibration/params_full_o.rda")