...
species_mat = sp_mat(rmax = c(2.0e+08,7.4e+08,2.0e+11,1.9e+10))
...
species_params(params_test)$z0 = c(0.00, 0.23, 0.33, 0.26)
species_params(params_test)$gamma = c(5.0e-11, 3.5e-11, 2.4e-11, 3.0e-11)
...
# Fit occupancy
species_params(params_tune)$z0 = c(0.00, 0.23, 0.33, 0.26)
species_params(params_tune)$gamma = c(5.0e-11, 3.5e-11, 2.4e-11, 3.0e-11)
...
params_test = params_tune
species_params(params_test)$R_max = c(7.3e+07,3.9e+08,6.0e+11,2.5e+10)
sim_test = project(params_test, t_max = t_tune, effort = effort_hypoxia)
plotBiomassObservedVsModel(sim_test)
plotBiomass(sim_test)

# Fit biomass and growth
par_bg = c(log10(c(7.3e+07,3.9e+08,6.0e+11,2.5e+10)), log10(species_params(params_tune)$gamma))
...
save(object = bo_fit, file = "Sensitivity/One/Calibration/bo_fit.rda")

# Save the final objects
save(object = params_tune, file = "Sensitivity/One/Calibration/params_tune_bo.rda")
save(object = params_time, file = "Sensitivity/One/Calibration/params_time_bo.rda")


########## X. Analysis ##########

# Load the final objects
load("Sensitivity/One/Calibration/params_tune_bo.rda")
load("Sensitivity/One/Calibration/params_time_bo.rda")
...
save(object = params_full, file = "Sensitivity/One/Calibration/params_full_bo.rda")