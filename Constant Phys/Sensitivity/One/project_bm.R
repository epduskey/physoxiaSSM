...
species_mat = sp_mat(rmax = c(2.1e+08,7.5e+08,2.0e+11,1.9e+10))
...
species_params(params_test)$z0 = c(0.00, 0.23, 0.34, 0.27)
species_params(params_test)$gamma = c(5.0e-11, 3.5e-11, 2.5e-11, 3.1e-11)
...
# Fit yield
par_yield = c(0.00, 0.23, 0.34, 0.27)
species_params(params_tune)$gamma = c(5.0e-11, 3.5e-11, 2.5e-11, 3.1e-11)
...
save(object = bm_fit, file = "Sensitivity/One/Calibration/bm_fit.rda")

# Save the final objects
save(object = params_tune, file = "Sensitivity/One/Calibration/params_tune_bm.rda")
save(object = params_time, file = "Sensitivity/One/Calibration/params_time_bm.rda")


########## X. Analysis ##########

# Load the final objects
load("Sensitivity/One/Calibration/params_tune_bm.rda")
load("Sensitivity/One/Calibration/params_time_bm.rda")
...
save(object = params_full, file = "Sensitivity/One/Calibration/params_full_bm.rda")