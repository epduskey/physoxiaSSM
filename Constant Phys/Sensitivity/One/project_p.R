# Run hypoxia model sensitivity analysis for P
...
species_mat = sp_mat(rmax = c(4.2e+08,9.2e+08,2.0e+11,1.9e+10))
...
species_params(params_test)$z0 = c(0.07, 0.22, 0.32, 0.25)
species_params(params_test)$gamma = c(1.1e-10, 4.3e-11, 2.5e-11, 3.0e-11)
...
# Fit yield
par_yield = c(0.07, 0.22, 0.32, 0.25)
species_params(params_tune)$gamma = c(1.1e-10, 4.3e-11, 2.5e-11, 3.0e-11)
...
params_test = params_tune
species_params(params_test)$R_max = c(1.2e+08,4.1e+08,5.3e+11,2.3e+10)
sim_test = project(params_test, t_max = t_tune, effort = effort_hypoxia)
plotBiomassObservedVsModel(sim_test)
plotBiomass(sim_test)

# Fit biomass and growth
par_bg = c(log10(c(1.2e+08,4.1e+08,5.3e+11,2.3e+10)), log10(species_params(params_tune)$gamma))
