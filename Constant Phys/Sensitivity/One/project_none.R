# Run hypoxia model sensitivity analysis for None (with left fish)
...
species_mat = sp_mat(rmax = c(1.9e+08,7.0e+08,2.0e+11,1.9e+10))
...
species_params(params_test)$gamma = c(4.8e-11, 3.2e-11, 2.3e-11, 3.0e-11)
...
species_params(params_tune)$gamma = c(4.8e-11, 3.2e-11, 2.3e-11, 3.0e-11)
...
params_test = params_tune
species_params(params_test)$R_max = c(7.2e+07,3.7e+08,6.0e+11,2.5e+10)
sim_test = project(params_test, t_max = t_tune, effort = effort_hypoxia)
plotBiomassObservedVsModel(sim_test)
plotBiomass(sim_test)

# Fit biomass and growth
par_bg = c(log10(c(7.2e+07,3.7e+08,6.0e+11,2.5e+10)), log10(species_params(params_tune)$gamma))
...
save(object = none_fit, file = "Sensitivity/One/Calibration/none_fit.rda")

# Save the final objects
save(object = params_tune, file = "Sensitivity/One/Calibration/params_tune_none.rda")
save(object = params_time, file = "Sensitivity/One/Calibration/params_time_none.rda")


########## X. Analysis ##########

# Load the final objects
load("Sensitivity/One/Calibration/params_tune_none.rda")
load("Sensitivity/One/Calibration/params_time_none.rda")
...
save(object = params_full, file = "Sensitivity/One/Calibration/params_full_none.rda")