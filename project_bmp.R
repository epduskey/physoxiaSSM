...
# Last modified: February 18, 2023 by EPD
...
species_mat = sp_mat(rmax = c(4.7e+08,9.8e+08,2.0e+11,1.9e+10))
...
params = oxy_sensitivity(params, 
				...
				a_hab = c(0, 0, 0, 0),
				U_search = c(1.0, 2.0, 10^5, 10^5),
				a_search = c(0.2, 0.1, 0, 0),
				U_maxin = c(1.0, 2.0, 10^5, 10^5),
				a_maxin = c(0.2, 0.1, 0, 0),
				U_erepro = c(1.0, 2.0, 10^5, 10^5),
				a_erepro = c(0.2, 0.1, 0, 0),
				U_alpha = c(1.0, 2.0, 10^5, 10^5),
				a_alpha = c(0.2, 0.1, 0, 0),
...
par_tg_cod_phys = c(rep(c(uc_cod,ac_cod),4),um_cod,am_cod)
yr_tg = seq(1991,2000)
t_tg = 100
...
params_time = oxy_sensitivity(params_time, 
				U_hab = c(10^5, 10^5, -10^5, -10^5),
				a_hab = c(0, 0, 0, 0),
				U_search = c(tg.optim.cod.phys$par[1], uc_flounder, 10^5, 10^5),
				a_search = c(tg.optim.cod.phys$par[2], ac_flounder, 0, 0),
				U_maxin = c(tg.optim.cod.phys$par[3], uc_flounder, 10^5, 10^5),
				a_maxin = c(tg.optim.cod.phys$par[4], ac_flounder, 0, 0),
				U_erepro = c(tg.optim.cod.phys$par[5], uc_flounder, 10^5, 10^5),
				a_erepro = c(tg.optim.cod.phys$par[6], ac_flounder, 0, 0),
				U_alpha = c(tg.optim.cod.phys$par[7], uc_flounder, 10^5, 10^5),
				a_alpha = c(tg.optim.cod.phys$par[8], ac_flounder, 0, 0),
				U_met = c(tg.optim.cod.phys$par[9], um_flounder, 10^5, 10^5),
				a_met = c(tg.optim.cod.phys$par[10], am_flounder, -10^5, -10^5),
...
par_tg_flounder_phys = c(rep(c(uc_flounder,ac_flounder),4),um_flounder,am_flounder)
yr_tg = seq(1991,2000)
t_tg = 100
...
params_time = oxy_sensitivity(params_time, 
				U_hab = c(10^5, 10^5, -10^5, -10^5),
				a_hab = c(0, 0, 0, 0),
				U_search = c(tg.optim.cod.phys$par[1], tg.optim.flounder.phys$par[1], 10^5, 10^5),
				a_search = c(tg.optim.cod.phys$par[2], tg.optim.flounder.phys$par[2], 0, 0),
				U_maxin = c(tg.optim.cod.phys$par[3], tg.optim.flounder.phys$par[3], 10^5, 10^5),
				a_maxin = c(tg.optim.cod.phys$par[4], tg.optim.flounder.phys$par[4], 0, 0),
				U_erepro = c(tg.optim.cod.phys$par[5], tg.optim.flounder.phys$par[5], 10^5, 10^5),
				a_erepro = c(tg.optim.cod.phys$par[6], tg.optim.flounder.phys$par[6], 0, 0),
				U_alpha = c(tg.optim.cod.phys$par[7], tg.optim.flounder.phys$par[7], 10^5, 10^5),
				a_alpha = c(tg.optim.cod.phys$par[8], tg.optim.flounder.phys$par[8], 0, 0),
				U_met = c(tg.optim.cod.phys$par[9], tg.optim.flounder.phys$par[9], 10^5, 10^5),
				a_met = c(tg.optim.cod.phys$par[10], tg.optim.flounder.phys$par[10], -10^5, -10^5),
				z_mort = c(zm_cod, zm_flounder, 0, 0),
				b_mort = c(bm_cod, bm_flounder, 0, 0))
...
save(object = bmp_fit, file = "Calibration/bmp_fit.rda")

# Save the final objects
save(object = params_tune, file = "Calibration/params_tune_bmp.rda")
save(object = params_time, file = "Calibration/params_time_bmp.rda")


########## X. Analysis ##########

# Load the final objects
load("Calibration/params_tune_bmp.rda")
load("Calibration/params_time_bmp.rda")
...
save(object = params_full, file = "Calibration/params_full_bmp.rda")