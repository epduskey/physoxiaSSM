...
species_mat = sp_mat(rmax = c(2.2e+08,8.1e+08,2.0e+11,1.9e+10))
...
species_params(params_test)$gamma = c(5.2e-11, 3.5e-11, 2.5e-11, 3.0e-11)
...
species_params(params_tune)$gamma = c(5.2e-11, 3.5e-11, 2.5e-11, 3.0e-11)
...
params_test = params_tune
species_params(params_test)$R_max = c(8.0e+07,4.2e+08,5.9e+11,2.5e+10)
sim_test = project(params_test, t_max = t_tune, effort = effort_hypoxia)
plotBiomassObservedVsModel(sim_test)
plotBiomass(sim_test)

# Fit biomass and growth
par_bg = c(log10(c(8.0e+07,4.2e+08,5.9e+11,2.5e+10)), log10(species_params(params_tune)$gamma))
...
save(object = bm_fit, file = "Calibration/bm_fit.rda")

# Save the final objects
save(object = params_tune, file = "Calibration/params_tune_bm.rda")
save(object = params_time, file = "Calibration/params_time_bm.rda")


########## X. Analysis ##########

# Load the final objects
load("Calibration/params_tune_bm.rda")
load("Calibration/params_time_bm.rda")
...
save(object = params_full, file = "Calibration/params_full_bm.rda")