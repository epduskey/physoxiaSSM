# Hypoxia physiological analysis for BO
...
species_mat = sp_mat(rmax = c(1.8e+08,7.4e+08,2.1e+11,2.0e+10))
...
species_params(params_test)$gamma = c(4.9e-11, 3.5e-11, 2.4e-11, 3.0e-11)
...
species_params(params_tune)$gamma = c(4.9e-11, 3.5e-11, 2.4e-11, 3.0e-11)
par_occ = c(0.8, 0.1)
...
params_test = params_tune
species_params(params_test)$R_max = c(6.9e+07,4.1e+08,5.8e+11,2.5e+10)
sim_test = project(params_test, t_max = t_tune, effort = effort_hypoxia)
plotBiomassObservedVsModel(sim_test)
plotBiomass(sim_test)

# Fit biomass and growth
par_bg = c(log10(c(6.9e+07,4.1e+08,5.8e+11,2.5e+10)), log10(species_params(params_tune)$gamma))
