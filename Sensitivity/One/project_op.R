...
species_mat = sp_mat(rmax = c(2.8e+08,8.6e+08,2.1e+11,1.9e+10))
...
species_params(params_test)$z0 = c(0.05, 0.22, 0.31, 0.25)
species_params(params_test)$gamma = c(7.8e-11, 4.0e-11, 2.4e-11, 3.1e-11)
...
# Fit occupancy
species_params(params_tune)$z0 = c(0.05, 0.22, 0.31, 0.25)
species_params(params_tune)$gamma = c(7.8e-11, 4.0e-11, 2.4e-11, 3.1e-11)
par_occ = c(0.8, 0.1)
...
params_test = params_tune
species_params(params_test)$R_max = c(9.5e+07,4.2e+08,5.2e+11,2.3e+10)
sim_test = project(params_test, t_max = t_tune, effort = effort_hypoxia)
plotBiomassObservedVsModel(sim_test)
plotBiomass(sim_test)

# Fit biomass and growth
par_bg = c(log10(c(9.5e+07,4.2e+08,5.2e+11,2.3e+10)), log10(species_params(params_tune)$gamma))
...
save(object = op_fit, file = "Sensitivity/One/Calibration/op_fit.rda")

# Save the final objects
save(object = params_tune, file = "Sensitivity/One/Calibration/params_tune_op.rda")
save(object = params_time, file = "Sensitivity/One/Calibration/params_time_op.rda")


########## X. Analysis ##########

# Load the final objects
load("Sensitivity/One/Calibration/params_tune_op.rda")
load("Sensitivity/One/Calibration/params_time_op.rda")
...
save(object = params_full, file = "Sensitivity/One/Calibration/params_full_op.rda")