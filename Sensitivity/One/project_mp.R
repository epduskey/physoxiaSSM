...
species_mat = sp_mat(rmax = c(3.9e+08,8.7e+08,2.0e+11,1.9e+10))
...
species_params(params_test)$z0 = c(0.05, 0.21, 0.31, 0.26)
species_params(params_test)$gamma = c(8.9e-11, 4.0e-11, 2.4e-11, 3.0e-11)
...
# Fit yield
par_yield = c(0.05, 0.21, 0.31, 0.26)
species_params(params_tune)$gamma = c(8.9e-11, 4.0e-11, 2.4e-11, 3.0e-11)
...
params_test = params_tune
species_params(params_test)$R_max = c(1.1e+08,3.9e+08,5.3e+11,2.4e+10)
sim_test = project(params_test, t_max = t_tune, effort = effort_hypoxia)
plotBiomassObservedVsModel(sim_test)
plotBiomass(sim_test)

# Fit biomass and growth
par_bg = c(log10(c(1.1e+08,3.9e+08,5.3e+11,2.4e+10)), log10(species_params(params_tune)$gamma))
...
save(object = mp_fit, file = "Sensitivity/One/Calibration/mp_fit.rda")

# Save the final objects
save(object = params_tune, file = "Sensitivity/One/Calibration/params_tune_mp.rda")
save(object = params_time, file = "Sensitivity/One/Calibration/params_time_mp.rda")


########## X. Analysis ##########

# Load the final objects
load("Sensitivity/One/Calibration/params_tune_mp.rda")
load("Sensitivity/One/Calibration/params_time_mp.rda")
...
save(object = params_full, file = "Sensitivity/One/Calibration/params_full_mp.rda")