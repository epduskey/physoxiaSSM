...
# Last modified: February 8, 2023 by EPD
...
species_mat = sp_mat(rmax = c(1.8e+08,7.0e+08,2.1e+11,2.0e+10))
...
params_test = params_tune
species_params(params_test)$R_max = c(7.1e+07,3.7e+08,6.0e+11,2.6e+10)
sim_test = project(params_test, t_max = t_tune, effort = effort_hypoxia)
plotBiomassObservedVsModel(sim_test)
plotBiomass(sim_test)

# Fit biomass and growth
par_bg = c(log10(c(7.1e+07,3.7e+08,6.0e+11,2.6e+10)), log10(species_params(params_tune)$gamma))
