# Hypoxia physiological analysis for BOM
...
species_mat = sp_mat(rmax = c(1.9e+08,7.6e+08,2.1e+11,2.0e+10))
...
species_params(params_test)$z0 = c(0.00, 0.22, 0.31, 0.26)
species_params(params_test)$gamma = c(5.0e-11, 3.3e-11, 2.3e-11, 3.0e-11)
...
# Fit occupancy
species_params(params_tune)$z0 = c(0.00, 0.22, 0.31, 0.26)
species_params(params_tune)$gamma = c(5.0e-11, 3.3e-11, 2.3e-11, 3.0e-11)
par_occ = c(0.8, 0.1)
...
params_test = params_tune
species_params(params_test)$R_max = c(7.4e+07,4.0e+08,5.7e+11,2.5e+10)
sim_test = project(params_test, t_max = t_tune, effort = effort_hypoxia)
plotBiomassObservedVsModel(sim_test)
plotBiomass(sim_test)

# Fit biomass and growth
par_bg = c(log10(c(7.4e+07,4.0e+08,5.7e+11,2.5e+10)), log10(species_params(params_tune)$gamma))
