...
cal_one = data.frame(model = model_labels)
cal_one$SSB = ssb_weight*cbe_rank
cal_one$yield = yield_weight*cye_rank
cal_one$growth = ssb_weight*cge_rank
cal_one$rank = cal_one$SSB + cal_one$yield + cal_one$growth
cal_one$SSB_error = cbe_error
cal_one$yield_error = cye_error
cal_one$growth_error = cge_error
write.table(cal_one, "Sensitivity/Output/cal_one.txt")
...
# Create and save error table
proj_one = data.frame(model = model_labels)
proj_one$SSB = ssb_weight*pbe_rank
proj_one$yield = yield_weight*pye_rank
proj_one$growth = growth_weight*pge_rank
proj_one$rank = proj_one$SSB + proj_one$yield + proj_one$growth
proj_one$SSB_error = pbe_error
proj_one$yield_error = pye_error
proj_one$growth_error = pge_error
write.table(proj_one, "Sensitivity/Output/proj_one.txt")