...
species_mat = sp_mat(rmax = c(1.9e+08,7.4e+08,2.1e+11,2.0e+10))
...
params_test = params_tune
species_params(params_test)$R_max = c(7.4e+07,4.0e+08,5.5e+11,2.5e+10)
sim_test = project(params_test, t_max = t_tune, effort = effort_hypoxia)
plotBiomassObservedVsModel(sim_test)
plotBiomass(sim_test)

# Fit biomass and growth
par_bg = c(log10(c(7.4e+07,4.0e+08,5.5e+11,2.5e+10)), log10(species_params(params_tune)$gamma))
