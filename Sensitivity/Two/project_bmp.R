...
# Last modified: February 26, 2023 by EPD
...
species_mat = sp_mat(rmax = c(4.9e+08,8.6e+08,2.0e+11,1.9e+10))
...
species_params(params_test)$gamma = c(1.0e-10, 3.9e-11, 2.3e-11, 3.1e-11)
...
species_params(params_tune)$gamma = c(1.0e-10, 3.9e-11, 2.3e-11, 3.1e-11)
...
params_test = params_tune
species_params(params_test)$R_max = c(1.3e+08,3.8e+08,5.1e+11,2.4e+10)
sim_test = project(params_test, t_max = t_tune, effort = effort_hypoxia)
plotBiomassObservedVsModel(sim_test)
plotBiomass(sim_test)

# Fit biomass and growth
par_bg = c(log10(c(1.3e+08,3.8e+08,5.1e+11,2.4e+10)), log10(species_params(params_tune)$gamma))
...
save(object = bmp_fit, file = "Sensitivity/Two/Calibration/bmp_fit.rda")

# Save the final objects
save(object = params_tune, file = "Sensitivity/Two/Calibration/params_tune_bmp.rda")
save(object = params_time, file = "Sensitivity/Two/Calibration/params_time_bmp.rda")


########## X. Analysis ##########

# Load the final objects
load("Sensitivity/Two/Calibration/params_tune_bmp.rda")
load("Sensitivity/Two/Calibration/params_time_bmp.rda")
...
save(object = params_full, file = "Sensitivity/Two/Calibration/params_full_bmp.rda")