...
species_mat = sp_mat(rmax = c(1.8e+08,6.7e+08,2.1e+11,2.0e+10))
...
species_params(params_test)$z0 = c(0.00, 0.21, 0.33, 0.26)
...
# Fit occupancy
species_params(params_tune)$z0 = c(0.00, 0.21, 0.33, 0.26)
...
params_test = params_tune
species_params(params_test)$R_max = c(7.1e+07,3.7e+08,5.7e+11,2.5e+10)
sim_test = project(params_test, t_max = t_tune, effort = effort_hypoxia)
plotBiomassObservedVsModel(sim_test)
plotBiomass(sim_test)

# Fit biomass and growth
par_bg = c(log10(c(7.1e+07,3.7e+08,5.7e+11,2.5e+10)), log10(species_params(params_tune)$gamma))
