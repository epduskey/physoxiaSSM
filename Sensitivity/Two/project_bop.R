...
species_mat = sp_mat(rmax = c(2.9e+08,8.2e+08,2.2e+11,2.0e+10))
...
params_tune = setBevertonHolt(setInitialValues(params_tune, sim_hypoxia), reproduction_level = c(0.90,0.90,0.31,0.85))
...
species_params(params_test)$z0 = c(0.05, 0.23, 0.29, 0.24)
species_params(params_test)$gamma = c(8.2e-11, 3.8e-11, 2.3e-11, 3.0e-11)
...
# Fit occupancy
species_params(params_tune)$z0 = c(0.05, 0.23, 0.29, 0.24)
species_params(params_tune)$gamma = c(8.2e-11, 3.8e-11, 2.3e-11, 3.0e-11)
par_occ = c(0.8, 0.1)
...
params_test = params_tune
species_params(params_test)$R_max = c(9.8e+07,4.0e+08,5.2e+11,2.4e+10)
sim_test = project(params_test, t_max = t_tune, effort = effort_hypoxia)
plotBiomassObservedVsModel(sim_test)
plotBiomass(sim_test)

# Fit biomass and growth
par_bg = c(log10(c(9.8e+07,4.0e+08,5.2e+11,2.4e+10)), log10(species_params(params_tune)$gamma))
...
save(object = bop_fit, file = "Sensitivity/Two/Calibration/bop_fit.rda")

# Save the final objects
save(object = params_tune, file = "Sensitivity/Two/Calibration/params_tune_bop.rda")
save(object = params_time, file = "Sensitivity/Two/Calibration/params_time_bop.rda")


########## X. Analysis ##########

# Load the final objects
load("Sensitivity/Two/Calibration/params_tune_bop.rda")
load("Sensitivity/Two/Calibration/params_time_bop.rda")
...
save(object = params_full, file = "Sensitivity/Two/Calibration/params_full_bop.rda")