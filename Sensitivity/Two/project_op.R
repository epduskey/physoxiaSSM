...
species_mat = sp_mat(rmax = c(2.7e+08,7.5e+08,2.1e+11,2.0e+10))
...
species_params(params_test)$z0 = c(0.04, 0.20, 0.31, 0.25)
species_params(params_test)$gamma = c(7.9e-11, 3.6e-11, 2.4e-11, 3.0e-11)
...
# Fit occupancy
species_params(params_tune)$z0 = c(0.04, 0.20, 0.31, 0.25)
species_params(params_tune)$gamma = c(7.9e-11, 3.6e-11, 2.4e-11, 3.0e-11)
par_occ = c(0.8, 0.1)
...
params_test = params_tune
species_params(params_test)$R_max = c(9.0e+07,3.7e+08,5.2e+11,2.4e+10)
sim_test = project(params_test, t_max = t_tune, effort = effort_hypoxia)
plotBiomassObservedVsModel(sim_test)
plotBiomass(sim_test)

# Fit biomass and growth
par_bg = c(log10(c(9.0e+07,3.7e+08,5.2e+11,2.4e+10)), log10(species_params(params_tune)$gamma))
...
save(object = op_fit, file = "Sensitivity/Two/Calibration/op_fit.rda")

# Save the final objects
save(object = params_tune, file = "Sensitivity/Two/Calibration/params_tune_op.rda")
save(object = params_time, file = "Sensitivity/Two/Calibration/params_time_op.rda")


########## X. Analysis ##########

# Load the final objects
load("Sensitivity/Two/Calibration/params_tune_op.rda")
load("Sensitivity/Two/Calibration/params_time_op.rda")
...
save(object = params_full, file = "Sensitivity/Two/Calibration/params_full_op.rda")