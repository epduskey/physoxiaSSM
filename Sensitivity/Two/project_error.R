...
cal_two = data.frame(model = model_labels)
cal_two$SSB = ssb_weight*cbe_rank
cal_two$yield = yield_weight*cye_rank
cal_two$growth = ssb_weight*cge_rank
cal_two$rank = cal_two$SSB + cal_two$yield + cal_two$growth
cal_two$SSB_error = cbe_error
cal_two$yield_error = cye_error
cal_two$growth_error = cge_error
write.table(cal_two, "Sensitivity/Output/cal_two.txt")
...
# Create and save error table
proj_two = data.frame(model = model_labels)
proj_two$SSB = ssb_weight*pbe_rank
proj_two$yield = yield_weight*pye_rank
proj_two$growth = growth_weight*pge_rank
proj_two$rank = proj_two$SSB + proj_two$yield + proj_two$growth
proj_two$SSB_error = pbe_error
proj_two$yield_error = pye_error
proj_two$growth_error = pge_error
write.table(proj_two, "Sensitivity/Output/proj_two.txt")