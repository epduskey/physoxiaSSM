# Hypoxia physiological analysis for M
...
species_params(params_test)$gamma = c(4.9e-11, 3.2e-11, 2.3e-11, 3.0e-11)
...
species_params(params_tune)$gamma = c(4.9e-11, 3.2e-11, 2.3e-11, 3.0e-11)
...
params_test = params_tune
species_params(params_test)$R_max = c(7.9e+07,3.8e+08,5.9e+11,2.5e+10)
sim_test = project(params_test, t_max = t_tune, effort = effort_hypoxia)
plotBiomassObservedVsModel(sim_test)
plotBiomass(sim_test)

# Fit biomass and growth
par_bg = c(log10(c(7.9e+07,3.8e+08,5.9e+11,2.5e+10)), log10(species_params(params_tune)$gamma))
...
bg.optim = optimParallel(par = par_bg, params = params_tune, fit_bg, dat = dat_bg, yr = yr_bg, t = t_bg, effort = effort_hypoxia, lower = c(5,5,5,5,-15,-15,-15,-15), upper = c(15,15,15,15,-5,-5,-5,-5), method = "L-BFGS-B", control = list(factr=1e8), parallel = list(cl=cl,loginfo=T))
stopCluster(cl)
