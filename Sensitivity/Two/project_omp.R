...
species_mat = sp_mat(rmax = c(3.1e+08,7.5e+08,2.2e+11,2.0e+10))
...
species_params(params_test)$gamma = c(7.7e-11, 3.6e-11, 2.3e-11, 3.0e-11)
...
species_params(params_tune)$gamma = c(7.7e-11, 3.6e-11, 2.3e-11, 3.0e-11)
par_occ = c(0.8, 0.1)
...
params_test = params_tune
species_params(params_test)$R_max = c(9.8e+07,3.6e+08,5.1e+11,2.3e+10)
sim_test = project(params_test, t_max = t_tune, effort = effort_hypoxia)
plotBiomassObservedVsModel(sim_test)
plotBiomass(sim_test)

# Fit biomass and growth
par_bg = c(log10(c(9.8e+07,3.6e+08,5.1e+11,2.3e+10)), log10(species_params(params_tune)$gamma))
...
bg.optim = optimParallel(par = par_bg, params = params_tune, fit_bg, dat = dat_bg, yr = yr_bg, t = t_bg, effort = effort_hypoxia, lower = c(5,5,5,5,-15,-15,-15,-15), upper = c(15,15,15,15,-5,-5,-5,-5), method = "L-BFGS-B", control = list(factr=1e9), parallel = list(cl=cl,loginfo=T))
stopCluster(cl)
...
save(object = omp_fit, file = "Sensitivity/Two/Calibration/omp_fit.rda")

# Save the final objects
save(object = params_tune, file = "Sensitivity/Two/Calibration/params_tune_omp.rda")
save(object = params_time, file = "Sensitivity/Two/Calibration/params_time_omp.rda")


########## X. Analysis ##########

# Load the final objects
load("Sensitivity/Two/Calibration/params_tune_omp.rda")
load("Sensitivity/Two/Calibration/params_time_omp.rda")
...
save(object = params_full, file = "Sensitivity/Two/Calibration/params_full_omp.rda")