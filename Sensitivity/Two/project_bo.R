...
species_params(params_test)$z0 = c(0.00, 0.23, 0.32, 0.25)
...
# Fit occupancy
species_params(params_tune)$z0 = c(0.00, 0.23, 0.32, 0.25)
...
params_test = params_tune
species_params(params_test)$R_max = c(6.9e+07,4.0e+08,5.5e+11,2.5e+10)
sim_test = project(params_test, t_max = t_tune, effort = effort_hypoxia)
plotBiomassObservedVsModel(sim_test)
plotBiomass(sim_test)

# Fit biomass and growth
par_bg = c(log10(c(6.9e+07,4.0e+08,5.5e+11,2.5e+10)), log10(species_params(params_tune)$gamma))
