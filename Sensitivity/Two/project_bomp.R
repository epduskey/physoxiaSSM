...
# Last modified: February 25, 2023 by EPD
...
species_mat = sp_mat(rmax = c(3.3e+08,8.2e+08,2.1e+11,2.0e+10))
...
params_tune = setBevertonHolt(setInitialValues(params_tune, sim_hypoxia), reproduction_level = c(0.90,0.90,0.32,0.85))
...
species_params(params_test)$z0 = c(0.05, 0.21, 0.29, 0.24)
...
# Fit occupancy
species_params(params_tune)$z0 = c(0.05, 0.21, 0.29, 0.24)
...
params_test = params_tune
species_params(params_test)$R_max = c(1.0e+08,3.9e+08,4.7e+11,2.4e+10)
sim_test = project(params_test, t_max = t_tune, effort = effort_hypoxia)
plotBiomassObservedVsModel(sim_test)
plotBiomass(sim_test)

# Fit biomass and growth
par_bg = c(log10(c(1.0e+08,3.9e+08,4.7e+11,2.4e+10)), log10(species_params(params_tune)$gamma))
...
save(object = bomp_fit, file = "Sensitivity/Two/Calibration/bomp_fit.rda")

# Save the final objects
save(object = params_tune, file = "Sensitivity/Two/Calibration/params_tune_bomp.rda")
save(object = params_time, file = "Sensitivity/Two/Calibration/params_time_bomp.rda")


########## X. Analysis ##########

# Load the final objects
load("Sensitivity/Two/Calibration/params_tune_bomp.rda")
load("Sensitivity/Two/Calibration/params_time_bomp.rda")
...
save(object = params_full, file = "Sensitivity/Two/Calibration/params_full_bomp.rda")