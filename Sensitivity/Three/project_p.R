...
# Last modified: March 3, 2023 by EPD
...
species_mat = sp_mat(rmax = c(3.8e+08,8.2e+08,2.0e+11,1.9e+10))
...
species_params(params_test)$z0 = c(0.06, 0.20, 0.32, 0.26)
species_params(params_test)$gamma = c(9.7e-11, 4.0e-11, 2.5e-11, 3.0e-11)
...
# Fit yield
par_yield = c(0.06, 0.20, 0.32, 0.26)
species_params(params_tune)$gamma = c(9.7e-11, 4.0e-11, 2.5e-11, 3.0e-11)
...
params_test = params_tune
species_params(params_test)$R_max = c(1.1e+08,3.7e+08,5.4e+11,2.4e+10)
sim_test = project(params_test, t_max = t_tune, effort = effort_hypoxia)
plotBiomassObservedVsModel(sim_test)
plotBiomass(sim_test)

# Fit biomass and growth
par_bg = c(log10(c(1.1e+08,3.7e+08,5.4e+11,2.4e+10)), log10(species_params(params_tune)$gamma))
...
save(object = p_fit, file = "Sensitivity/Three/Calibration/p_fit.rda")

# Save the final objects
save(object = params_tune, file = "Sensitivity/Three/Calibration/params_tune_p.rda")
save(object = params_time, file = "Sensitivity/Three/Calibration/params_time_p.rda")


########## X. Analysis ##########

# Load the final objects
load("Sensitivity/Three/Calibration/params_tune_p.rda")
load("Sensitivity/Three/Calibration/params_time_p.rda")
...
save(object = params_full, file = "Sensitivity/Three/Calibration/params_full_p.rda")