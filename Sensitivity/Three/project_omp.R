...
species_mat = sp_mat(rmax = c(4.5e+08,9.3e+08,2.0e+11,1.9e+10))
...
species_params(params_test)$gamma = c(9.9e-11, 4.0e-11, 2.3e-11, 3.0e-11)
...
# Fit occupancy
species_params(params_tune)$z0 = c(0.06, 0.22, 0.31, 0.26)
species_params(params_tune)$gamma = c(9.9e-11, 4.0e-11, 2.3e-11, 3.0e-11)
par_occ = c(0.8, 0.1)
...
params_test = params_tune
species_params(params_test)$R_max = c(1.3e+08,4.2e+08,5.3e+11,2.4e+10)
sim_test = project(params_test, t_max = t_tune, effort = effort_hypoxia)
plotBiomassObservedVsModel(sim_test)
plotBiomass(sim_test)

# Fit biomass and growth
par_bg = c(log10(c(1.3e+08,4.2e+08,5.3e+11,2.4e+10)), log10(species_params(params_tune)$gamma))
...
save(object = omp_fit, file = "Sensitivity/Three/Calibration/omp_fit.rda")

# Save the final objects
save(object = params_tune, file = "Sensitivity/Three/Calibration/params_tune_omp.rda")
save(object = params_time, file = "Sensitivity/Three/Calibration/params_time_omp.rda")


########## X. Analysis ##########

# Load the final objects
load("Sensitivity/Three/Calibration/params_tune_omp.rda")
load("Sensitivity/Three/Calibration/params_time_omp.rda")
...
save(object = params_full, file = "Sensitivity/Three/Calibration/params_full_omp.rda")