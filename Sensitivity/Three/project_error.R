...
cal_three = data.frame(model = model_labels)
cal_three$SSB = ssb_weight*cbe_rank
cal_three$yield = yield_weight*cye_rank
cal_three$growth = ssb_weight*cge_rank
cal_three$rank = cal_three$SSB + cal_three$yield + cal_three$growth
cal_three$SSB_error = cbe_error
cal_three$yield_error = cye_error
cal_three$growth_error = cge_error
write.table(cal_three, "Sensitivity/Output/cal_three.txt")
...
# Create and save error table
proj_three = data.frame(model = model_labels)
proj_three$SSB = ssb_weight*pbe_rank
proj_three$yield = yield_weight*pye_rank
proj_three$growth = growth_weight*pge_rank
proj_three$rank = proj_three$SSB + proj_three$yield + proj_three$growth
proj_three$SSB_error = pbe_error
proj_three$yield_error = pye_error
proj_three$growth_error = pge_error
write.table(proj_three, "Sensitivity/Output/proj_three.txt")