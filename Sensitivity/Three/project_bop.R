# Hypoxia physiological analysis for BOP
...
species_mat = sp_mat(rmax = c(4.7e+08,9.7e+08,2.0e+11,1.9e+10))
...
species_params(params_test)$z0 = c(0.08, 0.22, 0.30, 0.25)
...
# Fit occupancy
species_params(params_tune)$z0 = c(0.08, 0.22, 0.30, 0.25)
...
params_test = params_tune
species_params(params_test)$R_max = c(1.2e+08,4.2e+08,5.1e+11,2.4e+10)
sim_test = project(params_test, t_max = t_tune, effort = effort_hypoxia)
plotBiomassObservedVsModel(sim_test)
plotBiomass(sim_test)

# Fit biomass and growth
par_bg = c(log10(c(1.2e+08,4.2e+08,5.1e+11,2.4e+10)), log10(species_params(params_tune)$gamma))
...
save(object = bop_fit, file = "Sensitivity/Three/Calibration/bop_fit.rda")

# Save the final objects
save(object = params_tune, file = "Sensitivity/Three/Calibration/params_tune_bop.rda")
save(object = params_time, file = "Sensitivity/Three/Calibration/params_time_bop.rda")


########## X. Analysis ##########

# Load the final objects
load("Sensitivity/Three/Calibration/params_tune_bop.rda")
load("Sensitivity/Three/Calibration/params_time_bop.rda")
...
save(object = params_full, file = "Sensitivity/Three/Calibration/params_full_bop.rda")