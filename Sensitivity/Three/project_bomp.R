...
# Last modified: February 28, 2023 by EPD
...
species_mat = sp_mat(rmax = c(5.0e+08,9.5e+08,2.0e+11,1.9e+10))
...
species_params(params_test)$z0 = c(0.07, 0.21, 0.30, 0.25)
species_params(params_test)$gamma = c(1.0e-10, 4.3e-11, 2.3e-11, 3.0e-11)
...
# Fit occupancy
species_params(params_tune)$z0 = c(0.07, 0.21, 0.30, 0.25)
species_params(params_tune)$gamma = c(1.0e-10, 4.3e-11, 2.3e-11, 3.0e-11)
par_occ = c(0.8, 0.1)
...
params_test = params_tune
species_params(params_test)$R_max = c(1.3e+08,4.2e+08,5.1e+11,2.4e+10)
sim_test = project(params_test, t_max = t_tune, effort = effort_hypoxia)
plotBiomassObservedVsModel(sim_test)
plotBiomass(sim_test)

# Fit biomass and growth
par_bg = c(log10(c(1.3e+08,4.2e+08,5.1e+11,2.4e+10)), log10(species_params(params_tune)$gamma))
...
save(object = bomp_fit, file = "Sensitivity/Three/Calibration/bomp_fit.rda")

# Save the final objects
save(object = params_tune, file = "Sensitivity/Three/Calibration/params_tune_bomp.rda")
save(object = params_time, file = "Sensitivity/Three/Calibration/params_time_bomp.rda")


########## X. Analysis ##########

# Load the final objects
load("Sensitivity/Three/Calibration/params_tune_bomp.rda")
load("Sensitivity/Three/Calibration/params_time_bomp.rda")
...
save(object = params_full, file = "Sensitivity/Three/Calibration/params_full_bomp.rda")